namespace BesmashContent
{
    public abstract class DeffensiveAbility : Ability
    {
        ...
        public DeffensiveAbility(Entity user, int cost, string name, int range) : base(user, cost, name)
        {
            maxRange = range;
        }
        ...
        public bool isInRange(Entity target)    //Überprüft ob das Ziel in Reichweite des Nutzers ist
        {
            //todo
